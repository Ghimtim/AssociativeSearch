...
import com.jnu.associativesearch.Adapter.RecyclerAdapter;
import com.jnu.associativesearch.Listener.HidingScollListener;
import com.jnu.associativesearch.SmsObserver;
import com.jnu.associativesearch.beans.RelatedRecord;
import com.jnu.associativesearch.broadcast.CallReceiver;
import com.jnu.associativesearch.broadcast.MusicReceiver;
import com.jnu.associativesearch.broadcast.SmsReceiver;
...
import com.jnu.associativesearch.beans.Condition;
import com.jnu.associativesearch.utils.RecordUtils;
...
public class SearchMainActivity extends AppCompatActivity implements  DialogInterface.OnClickListener,RecyclerAdapter.OnRecyclerViewItemClickListener,RecyclerAdapter.OnSwipeSearchClickListener,RecyclerAdapter.OnSwipeOpenClickListener,TextWatcher,DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener,AdapterView.OnItemSelectedListener,ServiceConnection{
   ...
   /* public  String getContent() {
    ...
    /*    iF.addAction("com.netease.cloudmusic.service.PlayService");
        ...
        iF.addAction("com.netease.cloudmusic.metachanged");*/
            ...
            mListRelatedRecord = recordDaoImpl.queryRecords(condition.getContent(),condition.getStart_time(),condition.getEnd_time(),condition.getMime());
            recyclerAdapter = new RecyclerAdapter(this, mListRelatedRecord );
            recyclerAdapter.setOnRecyclerViewItemClickListener(this);
//            recyclerAdapter.setOnSwipeSearchClickListener(this);
//            recyclerAdapter.setOnSwipeOpenClickListener(this);
            ...
            if(smsReceiver == null){
                ...
                IntentFilter smsIF = new IntentFilter();
                smsIF.addAction("android.provider.Telephony.SMS_RECEIVED");
                registerReceiver(smsReceiver, smsIF);
            }
...
//wps receiver
 ...
 /*private List<String> createItemList1() {
    ...
    private List<String> createItemList2() {
        List<String> itemList = new ArrayList<>();
        for(int i=0;i<20;i++) {
            itemList.add("我是Item "+i);
        }
        return itemList;
    }*/
...
//           getText().toString().length() == 0
    ...
    @Override
    public void onSwipeSearchClick(View v) {
    ...
    @Override
    public void onSwipeOpenClick(View v) {
        int tag = (int)v.getTag();
        record = mListRelatedRecord.get(tag);
        RecordUtils.openRecord(this,record.getName(),record.getPath(),record.getMime());
    }
